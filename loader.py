...
class DatasetMask(Dataset):
    ...
    def __getitem__(self, index):
        ...
        for img in output[0]:
            ...
            high = self.get_pred_ratio() * H * W  # 最多mask 0.3×14×14 58个，随机mask
            ...
            if self.pred_shape == 'block':
                ...
                while mask_count < high:
                    ...
                    for attempt in range(10):
                        ...
                        h = int(round(math.sqrt(target_area * aspect_ratio)))  # mask的高
                        w = int(round(math.sqrt(target_area / aspect_ratio)))  # mask宽
                        if w < W and h < H:
